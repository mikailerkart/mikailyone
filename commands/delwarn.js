...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.permissions.has('MANAGE_ROLES')) return message.reply("Warn silmen için yetkin yok.")
    ...
    var embed = new discord.MessageEmbed()
        ...
        .setTimestamp()
        .setDescription(`**Warned deleted of:** ${warnUser.user.username} (${warnUser.id})
            **Warned deleted by:** ${message.author}
            **Reason: ** ${reason}`)
